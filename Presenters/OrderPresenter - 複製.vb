...
'    Public Sub New(view As IOrderView, service As ICusOrdByCarService, compRep As ICompanyRep, ordRep As IOrderRep)
'        _view = view
'        _service = service
'        _ordRep = ordRep
...
'    Public Async Sub Insert(container As Control)
'        Try
...
'    Public Async Sub Update(container As Control, ordId As Integer)
...
'    Public Async Sub Delete(orderId As Integer, orderName As String)
'        Dim ord = Await _ordRep.GetByIdAsync(orderId)
...
'        Dim cus = Await _cusRep.GetByIdAsync(cusId)
...
'    Public Async Function CalculateTotalPrice(gas As Integer, gasC As Integer, cusId As Integer, type As String, month As Date) As Task(Of Integer)
'        Dim cus = Await _cusRep.GetByIdAsync(cusId)
...
'    Public Sub CalculateInsurance(price As Single)
'        Dim result As Single = 0

'        If Not cusDetail.cus_IsInsurance Then
'            result = cusDetail.cus_InsurancePrice * price
'        End If

'        _view.ShowInsurance(result)
'    End Sub

'    Private Async Function LoadCompanyAsync() As Task
'        Try
'            Dim datas = Await _compRep.GetCompanyDropdownAsync
'            _view.SetCompanyCmb(datas)
'        Catch ex As Exception
'            Throw
'        End Try
'    End Function
