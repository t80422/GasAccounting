...
Public Class OrderVoucherVM
    ...
    Public Sub New(order As order)
        ...
        收空瓶10kg = order.o_in_10
        收空瓶14kg = order.o_in_14
        收空瓶18kg = order.o_in_18
        收空瓶16kg = order.o_in_16
        收空瓶20kg = order.o_in_20
        收空瓶2kg = order.o_in_2
        收空瓶4kg = order.o_in_4
        收空瓶50kg = order.o_in_50
        收空瓶5kg = order.o_in_5
        結存10kg = order.o_cus_10
        結存14kg = order.o_cus_14
        結存18kg = order.o_cus_18
        結存16kg = order.o_cus_16
        結存20kg = order.o_cus_20
        結存2kg = order.o_cus_2
        結存4kg = order.o_cus_4
        結存50kg = order.o_cus_50
        結存5kg = order.o_cus_5
        本日退氣 = order.o_return + order.o_return_c
        退空瓶50kg = order.o_empty_50
        退空瓶20kg = order.o_empty_20
        退空瓶16kg = order.o_empty_16
        退空瓶10kg = order.o_empty_10
        退空瓶4kg = order.o_empty_4
        退空瓶18kg = order.o_empty_18
        退空瓶2kg = order.o_empty_2
        退空瓶14kg = order.o_empty_14
        退空瓶5kg = order.o_empty_5
    End Sub
End Class
