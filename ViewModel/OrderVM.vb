Public Class OrderVM
    ...
    'Public Shared Function GetOrderList(data As IEnumerable(Of order)) As List(Of OrderVM)
    '    Dim list = data.Select(Function(x) New OrderVM With {
    '        .編號 = x.o_id,
    '        .時間 = x.o_date,
    ...
    '        .寄桶車號 = If(x.car1 IsNot Nothing, x.car1.c_no, Nothing),
    '        .退普氣 = x.o_return,
    '        .退丙氣 = x.o_return_c,
