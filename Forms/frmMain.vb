...
#End Region
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Dim InitCustStock(999)() As Integer
        ...
        'edit by kevin 20251111
        Dim db As New gas_accounting_systemEntities
        Dim query = From c In db.customers Select c
        Dim initCusStk As New GasBarrelDTO
        Dim initProps = initCusStk.GetType.GetProperties
        TextBox1.Text = Now.ToString
        For Each Cus In query
            If InitCustStock(CInt(Cus.cus_code))(0) <> Cus.cus_gas_50 Then TextBox1.Text = Cus.cus_code + "::50KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(1) <> Cus.cus_gas_20 Then TextBox1.Text = Cus.cus_code + "::20KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(2) <> Cus.cus_gas_16 Then TextBox1.Text = Cus.cus_code + "::16KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(3) <> Cus.cus_gas_10 Then TextBox1.Text = Cus.cus_code + "::10KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(4) <> Cus.cus_gas_4 Then TextBox1.Text = Cus.cus_code + "::4KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(5) <> Cus.cus_gas_18 Then TextBox1.Text = Cus.cus_code + "::18KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(6) <> Cus.cus_gas_14 Then TextBox1.Text = Cus.cus_code + "::14KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(7) <> Cus.cus_gas_5 Then TextBox1.Text = Cus.cus_code + "::5KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
            If InitCustStock(CInt(Cus.cus_code))(8) <> Cus.cus_gas_2 Then TextBox1.Text = Cus.cus_code + "::2KG 庫存有變動了!!" + vbCrLf + TextBox1.Text
        Next
